...
<body class="bg-white p-4 max-w-4xl mx-auto h[3508px] w-[2480px]">
    <div class="relative border border-gray-300 shadow-lg">
        ...
        <!-- Test Date -->
        <div class="px-6 py-2">
            <p><strong>Date Of Test</strong> : 04 MAR 2025</p>
        </div>
    ...
    <div class="row no-print">
        <div class="">
            <button class="btn btn-default" onclick="printPage();"><i class="fa fa-print"></i> Print</button>
        </div>
    </div>
...
<script>
    function printPage() {
    document.querySelector('.no-print').style.display = 'none'; // Hide print button
    window.print();
    document.querySelector('.no-print').style.display = 'block'; // Restore button after printing
}
