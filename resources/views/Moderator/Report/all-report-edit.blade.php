                            ...
                            <div class="x_content">
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('moderator.update.report') }}">
                                     ...
                                     <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input id="test_date" class="date-picker form-control" name="test_date" placeholder="dd-mm-yyyy" type="text" required="required" 
                                                ...
                                                onmouseover="(this.type='date')" value="{{ $report->test_date }}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input class="date-picker form-control" id="manu_date" 
                                                   value="{{ date('d-m-Y', strtotime($report->manufacture_date)) }}" 
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input id="next_test" class="date-picker form-control" placeholder="dd-mm-yyyy" value="{{ $report->next_retest }}" name="next_test" type="text" required="required" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="formatDate(this)" onmouseout="timeFunctionLong(this)">
                                            <script>
                                                function timeFunctionLong(input) {
                                                    setTimeout(function () {
                                                        input.type = 'text';
