...
>
  ...
  <body>
                      ...
                      <form id="formAccountSettings" method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" name="lastName" id="lastName" value="{{ Auth::user()->user_name }}" />
                          </div>
                          <div class="mb-3 col-md-6">
    ...
    <!-- Page JS -->
    <script src="{{ asset('storage/back/assets/js/pages-account-settings-account.js')}}"></script>
