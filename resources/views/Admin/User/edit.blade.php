                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('admin.profile.update') }}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" id="first-name" name="name" value="{{ Auth::user()->name }}" required="required" class="form-control ">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="email" id="first-name" name="email" value="{{ Auth::user()->email }}" required="required" class="form-control ">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" id="first-name" name="password" value="{{ Auth::user()->password }}" required="required" class="form-control ">
                                        </div>
                                    </div>
