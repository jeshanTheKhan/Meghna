...
<body>
    <div class="container">
        <header>
            <div class="header-content">
                <div class="logo-container">
                    <img src="cylinder-icon.png" alt="Cylinder Icon" class="logo">
                </div>
        ...
        <section class="owner-info">
            <h3>01. OWNER INFORMATION:</h3>
            <div class="info-row">
                <p><span class="info-label">Customer Name:</span> <span style="margin-left: 195px;">{{ $report->name }}</span></p>
                <p><span class="info-label">Customer User-Name:</span> <span style="margin-left: 150px;">{{ $report->user_name }}</span></p>
                <p><span class="info-label">Vehicle Reg. No:</span> <span style="margin-left: 195px;">{{ $report->vehicle_number }}</span></p>
            </div>
        </section>

        <section class="cylinder-details">
            
            <h3>02. CNG CYLINDER DETAILS:</h3>
            <div class="info-row">
                <p><span class="info-label">Cylinder Manufacturer:</span> <span style="margin-left: 150px;">{{ $report->cylinder_manu }}</span></p>
                <p><span class="info-label">Cylinder No:</span> <span style="margin-left: 230px;">{{ $report->cylinder_number }}</span></p>
                <p><span class="info-label">Country Of Origin:</span> <span style="margin-left: 185px;">{{ $report->cylinder_origin }}</span></p>
                <p><span class="info-label">Manufacturing Date:</span> <span style="margin-left: 172px;">{{ $report->manufacture_date }}</span></p>
                <p><span class="info-label">Water Capacity:</span> <span style="margin-left: 205px;">{{ $report->water_capacity }}</span></p>
        ...
        <div class="next-test">
            <h3>NEXT RE-TEST TIME: 03 MAR 202<span id="nextYear">6</span></h3>
        </div>
        ...
        <div class="conclusion">
            ...
            <p class="certification"><em>It is here by certified that above mentioned CNG Cylinder has been inspected and re-tested in accordance with Rule 51 of the CNG Rule 2005.</em></p>
        </div>
