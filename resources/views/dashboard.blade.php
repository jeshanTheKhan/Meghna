                      ...
                      <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                          <div class="card-body">
                            ...
                            <p class="mb-4">
                              Welcome to Meghna Engineering Cylinder Re-Test Center! Ensure safety and reliability with our expert cylinder testing services—visit our website today!
                            </p>
                        ...
                        <div class="col-sm-5 text-center text-sm-left">
                          <div class="card-body pb-0 px-0 px-md-4">
                            <img
                              src="{{ asset('storage/back/assets/img/illustrations/man-with-laptop-light.png') }}"
                              height="140"
                              alt="View Badge User"
                          ...
                          <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                              <div class="avatar flex-shrink-0">
                                <img
                                  src="{{ asset('storage/back/assets/img/icons/unicons/chart-success.png') }}"
                                  alt="chart success"
                                  class="rounded"
                                />
                              </div>
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                              <div class="avatar flex-shrink-0">
                                <img
                                  src="{{ asset('storage/back/assets/img/icons/unicons/wallet-info.png') }}"
                                  alt="Credit Card"
                                  class="rounded"
                                />
                              </div>
        ...
        <div class="table-responsive text-nowrap">
          <table class="table table-striped">
            ...
            <tbody class="table-border-bottom-0">
              ...
              <tr>
                <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $report->serial_number }}</strong></td>
                <td>{{ $report->cylinder_number }}</td>
                <td>{{ $report->user_name }}</td>
               
                <td>
                  <a href="{{route('report.download',$report->id)}}" type="button" class="btn btn-primary text-white">Download</a>
                </td>
              </tr>
              @endforeach
